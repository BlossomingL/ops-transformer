...
#define INVOKE_FAG_SMALL_SD_BN2_REGBASE_IMPL(INPUT_TYPE, CALC_TYPE, OUTDTYPE, IS_TND, s1TemplateType,                 \
    ...
    do {                                                                                                               \
        ...
        using CubeBlockType = typename std::conditional<                                                               \
            g_coreType == AscendC::AIC,                                                                                \
            FagBaseApi::FAGBlockCubeSmallSD<INPUT_TYPE, CALC_TYPE, OUTDTYPE, false, false, false, IS_TND, false,       \
                                            NO_DETER, false, false, false, false, false, BN2, s1TemplateType,          \
                                            s2TemplateType, dTemplateType>,                                            \
            FagBaseApi::FAGBlockCubeSmallSDDummy<INPUT_TYPE, CALC_TYPE, OUTDTYPE, false, false, false, IS_TND, false,  \
                                                 NO_DETER, false, false, false, false, false, BN2, s1TemplateType,     \
                                                 s2TemplateType, dTemplateType>>::type;                                \
        using VecBlockType = typename std::conditional<                                                                \
            g_coreType == AscendC::AIC,                                                                                \
            FagBaseApi::FAGBlockVecSmallSDDummy<INPUT_TYPE, CALC_TYPE, OUTDTYPE, false, false, false, IS_TND, false,   \
                                                NO_DETER, false, false, false, false, false, BN2, s1TemplateType,      \
                                                s2TemplateType, dTemplateType>,                                        \
            FagBaseApi::FAGBlockVecSmallSD<INPUT_TYPE, CALC_TYPE, OUTDTYPE, false, false, false, IS_TND, false,        \
                                           NO_DETER, false, false, false, false, false, BN2, s1TemplateType,           \
                                           s2TemplateType, dTemplateType>>::type;                                      \
